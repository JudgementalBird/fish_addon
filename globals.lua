...
function wipe_globals()
	ticks = nil
	ANNOUNCE_TO = nil
	usedport = nil
	disable_much_core_functionality = nil
	error_checking_not_relaxed = nil

	g_savedata.spawning_queue_data = nil

	g_savedata.fish_withdrawal_tasks = nil

	g_savedata.crane_glob_of_info = nil

	logging = nil

	hopper_resource_lookup = nil

	g_savedata.known_hopper_holding_vehicles = nil
end